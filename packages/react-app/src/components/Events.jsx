  ...
  return (
    <div style={{ width: 600, margin: "auto", marginTop: 32, paddingBottom: 32 }}>
      <h2>
        {eventName} Events
        <br />
        {eventName === "EthToTokenSwap" ? " ⟠ -->🎈 Address | Trade | AmountIn | AmountOut"
          : eventName === "TokenToEthSwap" ? "🎈-->⟠ Address | Trade | AmountOut | AmountIn"
          : eventName === "LiquidityProvided" ? "➕ Address | Liquidity Minted | Eth In | Balloons In"
          : eventName === "LiquidityRemoved" ? "➖ Address | Liquidity Withdrawn | ETH out | Balloons Out "
            ...
            <List.Item key={item.blockNumber + "_" + item.args[0].toString()}>
              <Address address={item.args[0]} ensProvider={mainnetProvider} fontSize={16} />
              {
                item.args[1].toString().indexOf("E") == -1 ? (
                  ...
                  item.args[1].toString().indexOf("0x") == 0 ? (
